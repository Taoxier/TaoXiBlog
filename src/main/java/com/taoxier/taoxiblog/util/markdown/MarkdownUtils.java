package com.taoxier.taoxiblog.util.markdown;

import com.taoxier.taoxiblog.util.markdown.ext.cover.CoverExtension;
import com.taoxier.taoxiblog.util.markdown.ext.heimu.HeimuExtension;
 ...
 * 有两种隐藏文字效果：在 Markdown 中使用@@包住文字，文字会被渲染成“黑幕”效果，鼠标悬浮在上面时才会显示；使用%%包住文字，文字会被“蓝色覆盖层”遮盖，只有鼠标选中状态才会反色显示。例如：@@隐藏文字@@，%%隐藏文字%%
 * @Author taoxier
 * @Date 2025/4/25
 */

...
<style scoped>
    ...
    z-index: 30;
    animation: malfunctionAni 2s infinite;
	}
    ...
    animation: malfunctionAni 2.5s infinite 0.3s;
	}

/* 更柔和的错位动画 */
/* @keyframes malfunctionAni {
    0%, 100% { transform: translateX(0); clip: rect(54px, 9999px, 58px, 0); }
    25% { transform: translateX(1px); clip: rect(42px, 9999px, 68px, 0); }
    50% { transform: translateX(-1px); clip: rect(51px, 9999px, 47px, 0); }
    75% { transform: translateX(0.5px); clip: rect(22px, 9999px, 88px, 0); }
}
